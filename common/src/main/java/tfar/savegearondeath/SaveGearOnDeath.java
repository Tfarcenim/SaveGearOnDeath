...
import tfar.savegearondeath.platform.Services;
...
public class SaveGearOnDeath {

    public static final String MOD_ID = "savegearondeath";
    public static final String MOD_NAME = "SaveGearOnDeath";
